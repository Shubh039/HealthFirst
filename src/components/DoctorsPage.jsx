          ...
          <div className="grid items-stretch gap-7 lg:grid-cols-2">
            ...
            {filteredDoctors.map((doctor) => (
              ...
              >
                ...
                <article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-brand-navy/10 bg-white shadow-[0_10px_40px_rgba(15,23,42,0.04)] transition-all duration-500 hover:-translate-y-1 hover:border-brand-gold/30 hover:shadow-[0_20px_55px_rgba(15,23,42,0.08)]">

                  {/* =================================================
                      TOP / PHOTO AREA
                  ================================================= */}
                  <div className="relative min-h-[390px] bg-[#f4f8fb] px-6 pt-7 sm:px-8">

                    <div className="flex h-full flex-col items-center">

                      {/* Circular Portrait */}
                      <div className="relative h-32 w-32 shrink-0 overflow-hidden rounded-full border-[3px] border-[#0794d2] bg-white shadow-[0_12px_35px_rgba(14,124,134,0.14)] sm:h-36 sm:w-36">
                      ...
                      {/* Experience Badge */}
                      <div className="mt-5 min-h-[30px] rounded-full bg-[#e1f2fb] px-4 py-1.5 text-center text-[10px] font-bold uppercase tracking-[0.08em] text-[#0878b6]">
                      ...
                      {/* Name */}
                      <h3 className="mt-4 text-center text-2xl font-bold leading-tight text-brand-navy">
                      ...
                      {/* Role */}
                      <div className="mt-2 flex min-h-[48px] items-center justify-center">

                        <p className="max-w-md text-center text-sm font-semibold leading-6 text-[#d97800]">
                      ...
                      {/* Specialty */}
                      <div className="mt-4 flex min-h-[72px] w-full max-w-lg items-center justify-center rounded-xl border border-[#9bdcff] bg-[#eff9ff] px-5 py-3 text-center text-sm font-semibold leading-6 text-[#0878b6]">
                  ...
                  <div className="flex flex-1 flex-col px-6 pb-7 pt-6 sm:px-8">
                    ...
                    {/* Divider */}
                    <div className="my-6 h-px shrink-0 bg-brand-gold/20" />
                      ...
                      <div className="space-y-3">
                        ...
                        {doctor.expertise.map((item) => (
                          ...
                          >
                            ...
                            <span className="text-sm font-medium leading-5 text-brand-navy/80">
                              {item}
                            </span>
